...
def p_block_stm_opt(p):
    '''block_stm_opt : empty
                     | statement block_stm_rec'''


def p_block_stm_rec(p):
    '''block_stm_rec : empty
                     | block_stm_opt'''
...
def p_cond_else_if_rec(p):
    '''cond_else_if_rec : empty 
                        | cond_else_if_opt'''
...
def p_function_stm(p):
    '''function_stm : empty 
                    | statement function_stm_rec'''


def p_function_stm_rec(p):
    '''function_stm_rec : empty 
                        | function_stm'''
